        ...
        <>
            <Wrapper>
                <Navbar expand="md" className='navcontainer'>
                    <Container>
                        <Navbar.Brand><img src={navlogo}></img></Navbar.Brand>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="ms-auto">
                                ...
                                {!isLogged &&
                                    <>
                                    <Nav.Link className='me-5'><Link to="rekisteröidy" className='link'>Rekisteröidy</Link></Nav.Link>
                                        <Nav.Link className='me-5'><Link to="kirjaudu" className='link'>Kirjaudu</Link></Nav.Link>
                                    </>
                                }
                            </Nav>
                        </Navbar.Collapse>
